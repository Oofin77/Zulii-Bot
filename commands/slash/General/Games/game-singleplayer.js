...
module.exports = {
  name: "games-singleplayer",
  description: "Play a single-player minigame within Discord.",
  type: 1,
  options: [
    {
      name: "game",
...
const randomWords = words[Math.floor(Math.random() * words.length)];
        {
          ...
          const Game = new FastType({
            ...
            timeoutTime: 60000,
            sentence: `${ randomWords || "Here is a cool sentence to type."}`,
            winMessage:
...
const randomWord = words[Math.floor(Math.random() * words.length)];
          ...
          const Game = new Hangman({
            ...
            customWord: `${ randomWord || "hangman"}`, //wordle will be used when the random shit doesn't work for some weird reason.
            hangman: {
              hat: "🎩",
              head: "😟",
              shirt: "👕",
